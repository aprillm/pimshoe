...
<body>
  ...
  <form class="form-horizontal" method="post" action="login_action.php">
     ...
     <input type="text" name="uname" class="form-control" id="inputEmail" placeholder="Enter username">
     </div>

     <div class="form-group">
     <label for="inputPass" class="font-weight-bold">Password</label>
     <input type="text" name="psw" class="form-control" id="inputPass" placeholder="Enter password">
     </div>
