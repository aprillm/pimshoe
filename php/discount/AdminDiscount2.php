...
<html lang="en">
  ...
  <body>
    ...
    <form class="form-horizontal" method="post" action="discount_action.php">
      ...
      <div class = "form-group container text-center">
        <h3 class="text-center"><?php echo $_SESSION["upc"];?></h3>
          ...
          <div class="col-sm-2">
            <label for="inputDiscount">Select Discount</label>
        ...
        <div class="custom-control custom-switch mt-3">
          <input type="checkbox" name="activeDiscount" class="custom-control-input" id="customSwitch1" unchecked>
  ...
  <div class="container text-center mt-5">
    <a href="AdminDiscount.php" class="btn btn-primary">
      Choose another UPC
    </a>
  </div>
