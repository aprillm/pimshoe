  ...
  <body>
    ...
    <div class="container text-center mt-5" style="margin-bottom:0">
      <h2>Discount Manager</h2>
        ...
        <form class="form-horizontal" method="post" action="firstUpdateDiscount_action.php">

          <div class = "form-group container text-center mt-5">

              <label for="updateUPC">Select the current discount you wish to update</label>
              <select class = "form-control" name ="discupc" id="updateUPC" required>
