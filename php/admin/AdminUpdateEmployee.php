  ...
  <body>
    ...
    <div class="container text-center mt-5" style="margin-bottom:0">
      <h2>Update Employee</h2>
        ...
        <form class="form-horizontal" method="post" action="firstUpdateEmployee_action.php">

          <div class = "form-group container text-center mt-5">

              <label for="updateUPC">Select the Employee you wish to update</label>
              <select class = "form-control" name ="editEmp" id="updateUPC" required>
                  <option value="">Employee</option>
                      <?php
                        ...
                        foreach ($datas as $data){
                          array_push($storeArray,$data['userID']);
                        }
