...
<html lang="en">
  ...
  <body>
    ...
    <form class="form-horizontal" method="post" action="firstUpdateStore_action.php">

      <div class = "form-group container text-center mt-5">

          <label for="updateUPC">Select the store you wish to update</label>
          <select class = "form-control" name ="editstore" id="updateUPC" required>
